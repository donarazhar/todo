                        ...
                        @if($t->laporan)
                            <div class="task-card-report">
                                ...
                                @if($t->file_laporan)
                                            ...
                                            <div style="margin-top: 6px;">
                                                @if($isImage3)
                                                    <a href="#" @click.prevent="openImageModal('{{ asset('storage/' . $t->file_laporan) }}')" class="task-card-report-link"><i class="bi bi-image"></i> Lihat Gambar</a>
                                                @else
                    ...
                    @else
                        ...
                        @elseif($t->status === 'Menunggu Review')
                            <div class="task-card-report">
                                ...
                                @if($t->file_laporan)
                                    @php
                                        $ext5 = strtolower(pathinfo($t->file_laporan, PATHINFO_EXTENSION));
                                        $isImage5 = in_array($ext5, ['jpg', 'jpeg', 'png', 'gif', 'webp']);
                                    @endphp
                                    @if($isImage5)
                                        <a href="#" @click.prevent="openImageModal('{{ asset('storage/' . $t->file_laporan) }}')" class="task-card-report-link"><i class="bi bi-image"></i> Lihat Gambar</a>
                                    @else
