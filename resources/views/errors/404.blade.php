...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-size: 80px; font-weight: 700; color: var(--primary-600); line-height: 1; margin-bottom: 16px; }
...
<body>
    <div class="error-container">
        ...
        <p class="error-desc">Maaf, halaman yang Anda cari tidak dapat ditemukan. Mungkin telah dihapus, diubah namanya, atau tidak pernah ada.</p>
